...
<p align="center">
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/marwanrefaat/inbox-zero/issues">Issues</a>
  </p>
</p>

<div align="center">

![Stars](https://img.shields.io/github/stars/marwanrefaat/inbox-zero?labelColor=black&style=for-the-badge&color=2563EB)
![Forks](https://img.shields.io/github/forks/marwanrefaat/inbox-zero?labelColor=black&style=for-the-badge&color=2563EB)

<a href="https://trendshift.io/repositories/6400" target="_blank"><img src="https://trendshift.io/api/badge/repositories/6400" alt="marwanrefaat%2Finbox-zero | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmarwanrefaat%2Finbox-zero&env=AUTH_SECRET,GOOGLE_CLIENT_ID,GOOGLE_CLIENT_SECRET,MICROSOFT_CLIENT_ID,MICROSOFT_CLIENT_SECRET,EMAIL_ENCRYPT_SECRET,EMAIL_ENCRYPT_SALT,UPSTASH_REDIS_URL,UPSTASH_REDIS_TOKEN,GOOGLE_PUBSUB_TOPIC_NAME,DATABASE_URL,NEXT_PUBLIC_BASE_URL)
...
[![Star History Chart](https://api.star-history.com/svg?repos=marwanrefaat/inbox-zero&type=Date)](https://www.star-history.com/#marwanrefaat/inbox-zero&Date)

## Feature Requests

To request a feature open a [GitHub issue](https://github.com/marwanrefaat/inbox-zero/issues), or join our [Discord](https://www.getinboxzero.com/discord).
...
You can view open tasks in our [GitHub Issues](https://github.com/marwanrefaat/inbox-zero/issues).
